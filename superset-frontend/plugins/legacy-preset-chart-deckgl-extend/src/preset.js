...
import ScatterChartPluginExtend from './layers/Scatter';
import ScreengridChartPlugin from './layers/Screengrid';

export default class DeckGLChartPresetExtend extends Preset {
  constructor() {
    super({
      name: 'deck.gl charts',
      plugins: [
        ...
        new ScatterChartPluginExtend().configure({ key: 'deck_scatter_extend' }),
