...
export type ColumnColorFormatingConfig = {
  operator?: COMPARATOR;
  targetValue?: number;
...
export type ColumnColorFormatingControlProps = ControlComponentProps<
...
export type ColumnColorFormattingPopoverProps = PopoverProps & {
  ...
  onChange: (value: ColumnColorFormatingConfig) => void;
