...
const shouldFormItemUpdate = (
  prevValues: ExtendTableConditionalFormattingConfig,
  currentValues: ExtendTableConditionalFormattingConfig,
) =>
...
export const FormattingPopoverContent = ({
  ...
  onChange: (config: ExtendTableConditionalFormattingConfig) => void;
