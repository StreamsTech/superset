...
import {
  COMPARATOR,
  ExtendTableConditionalFormattingConfig,
  ExtendTableConditionalFormattingControlProps,
} from './types';
import {
  AddControlLabel,
  CaretContainer,
...
const ExtendTableConditionalFormattingControl = ({
  value,
  onChange,
  columnOptions,
  verboseMap,
  ...
  const [conditionalFormattingConfigs, setConditionalFormattingConfigs] =
    useState<ExtendTableConditionalFormattingConfig[]>(value ?? []);
  ...
  const onSave = (config: ExtendTableConditionalFormattingConfig) => {
    setConditionalFormattingConfigs(prevConfigs => [...prevConfigs, config]);
  };

  const onEdit = (newConfig: ExtendTableConditionalFormattingConfig, index: number) => {
        ...
        {conditionalFormattingConfigs.map((config, index) => (
          <FormatterContainer key={index}>
            ...
            <FormattingPopover
              ...
              onChange={(newConfig: ExtendTableConditionalFormattingConfig) =>
...
export default ExtendTableConditionalFormattingControl;